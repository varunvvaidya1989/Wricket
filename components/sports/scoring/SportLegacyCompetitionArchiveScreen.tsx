...
export function SportLegacyCompetitionArchiveScreen({
  ...
  if (loading) return <Screen padded={false}><SportStageLoader message={`Loading ${config.name} archive`} detail="Restoring saved competitions and match history" accent={presentation.accent} /></Screen>;
  if (detail) {
